...
import com.example.jetpacksubmission.view.FavoriteHolderFragment
...
class FavoritePagerAdapter(private val context: Context, fm: FragmentManager) : FragmentPagerAdapter(fm, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
    ...
    override fun getItem(position: Int): Fragment = FavoriteHolderFragment.newInstance(position + 1)
