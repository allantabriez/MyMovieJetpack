...
class CatalogueRepository private constructor(
    ...
    companion object {
        ...
        fun getInstance(remoteData: RemoteDataSource, localData: LocalDataSource): CatalogueRepository = instance ?: synchronized(this) {
            instance ?: CatalogueRepository(remoteData, localData)
        }
    }
